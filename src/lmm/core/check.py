...
def modules(folder=None):
    # The core package IS this file's own directory. Deriving it beats a
    # relative name that only resolved from one working directory.
