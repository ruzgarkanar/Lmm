...
TEMPLATE = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 980 470"
     ...
     aria-label="LMM architecture: documents, tables and messages pass an entry gate into a graph memory with evidence; a question retrieves from that memory, a small engine phrases the answer, and an exit gate either releases it or drops it.">
  <defs>
  ...
  <text x="474" y="152" class="l">evidence index</text>
  <text x="474" y="168" class="s">sentences, kept verbatim</text>
  <text x="474" y="192" class="g">DERIVES · NO MODEL CALL</text>
  ...
  <text x="196" y="344" class="s">graph lookup + evidence — deterministic</text>
